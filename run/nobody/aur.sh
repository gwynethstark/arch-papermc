...
if [[ ! -z "${aur_packages}" ]]; then
	...
	if ! which yay; then
		...
		aur_helper_package_name="yay-git-11.0.2.r33.g81eeb8c-1-x86_64.pkg.tar.zst"

		# download compiled aur helper
		rcurl.sh -o "/tmp/${aur_helper_package_name}" "https://github.com/gwynethstark/arch-packages/raw/master/compiled/yay-git-11.0.2.r33.g81eeb8c-1-x86_64.pkg.tar.zst"
